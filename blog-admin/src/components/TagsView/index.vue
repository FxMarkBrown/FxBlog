...
onMounted(() => {
  ...
  tagsViewStore.addVisitedView(route)
  nextTick(() => {
    wheelTarget = scrollbarRef.value?.wrapRef || null
    wheelTarget?.addEventListener('wheel', handleScroll, { passive: false })
  })
})

onBeforeUnmount(() => {
  document.removeEventListener('click', closeMenu)
  wheelTarget?.removeEventListener('wheel', handleScroll)
  wheelTarget = null
})
</script>
