  ...
  <div class="navbar-container">
    ...
    <div class="navbar-right">
      ...
      <el-tooltip content="全屏切换" placement="bottom" >  
        <el-icon v-if="!isFullscreen" class="setting-icon" @click="toggleFullscreen">
          <FullScreen />
        </el-icon>
        <svg-icon v-else class="setting-icon svg-setting-icon" name="exitFullScreen" :size="20" @click="toggleFullscreen" />
      </el-tooltip>
      <!-- 用户信息 -->
