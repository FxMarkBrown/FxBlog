  ...
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <div v-loading="loading" class="album-list">
        <el-checkbox-group v-for="item in albumList" :key="item.id" v-model="selectedIds">
          <div class="album-item">
            <span class="album-checkbox">
              <el-checkbox :value="item.id" />
            </span>
            <el-image class="album-cover" :src="item.cover" />
            <div v-if="item.isLock" class="album-lock">
              <el-icon>
                <Lock />
              </el-icon>
            </div>
            ...
            <div class="album-action">
              <el-button
                ...
                size="small"
                icon="Edit"
                @click="handlePreviewPhotos(item)"
                >查看照片</el-button
              >
              <el-button
    ...
    >
      ...
      >
        ...
        <el-form-item v-if="albumForm.isLock === 1" label="密码" prop="password">
    ...
    <Photos v-model:open-photos="openPhotos" :album-id="albumForm.id" />
  </div>
</template>
...
const rules = reactive<FormRules>({
  ...
  isLock: [{ required: true, message: '请选择是否加密', trigger: 'blur' }]
})
