<template>
  <div class="app-container">
    ...
    >
      <el-form ref="formRef" :model="form" :rules="rules" label-width="80px" class="custom-form">
        <el-form-item label="站点名称" prop="name">
          <el-input v-model="form.name" placeholder="请输入站点名称" clearable />
        </el-form-item>
        <el-form-item label="站点地址" prop="url">
          <el-input v-model="form.url" placeholder="请输入站点地址" clearable />
        </el-form-item>
        <el-form-item label="站点头像" prop="avatar">
          <el-input v-model="form.avatar" placeholder="请输入站点头像" clearable />
        </el-form-item>
        <el-form-item label="站点描述" prop="info">
          <el-input v-model="form.info" placeholder="请输入站点描述" clearable />
        </el-form-item>
        ...
        <el-form-item label="状态" prop="status">
          <el-radio-group v-model="form.status">
            <el-radio v-for="item in statusList" :key="item.value" :value="item.value">{{
              item.label
            }}</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item label="排序" prop="sort">
          <el-input-number v-model="form.sort" :min="1" placeholder="请输入排序" clearable />
        </el-form-item>
      </el-form>
...
const rules = reactive<FormRules>({
  ...
  info: [{ required: true, message: '请输入友链描述', trigger: 'blur' }],
