...
@AllArgsConstructor
@NoArgsConstructor
@TableName("sys_ai_document_node_message")
@Schema(description = "AI 文档节点线程消息")
public class SysAiDocumentNodeMessage implements Serializable {
    ...
    @Schema(description = "文档问答上下文快照 JSON")
